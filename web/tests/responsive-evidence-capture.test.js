...
assert.match(exactSource, /const isMeasurable/);
assert.match(exactSource, /details:not\(\[open\]\)/);
assert.match(exactSource, /visibleSummary\?\.parentElement !== closedDetails/);
assert.match(exactSource, /\[inert\]/);
assert.match(exactSource, /\[aria-hidden='true'\]/);
