...
const testFiles = [
  ...
  "tests/artifact-tool-runtime.test.js",
  ...
  "tests/account-deletion-resume.test.js",
  ...
  "tests/launch-data-purge-safety.test.js",
  "tests/principles-smell-audit-contract.test.js",
  ...
  "tests/curriculum-top-timeline.test.js",
  ...
  "tests/coach-diagnostic-guidance.test.js",
  ...
  "tests/curriculum-motion-lesson.test.js",
  "tests/curriculum-story.test.js",
  "tests/curriculum-story-order.test.js",
  "tests/curriculum-story-originality.test.js",
  "tests/curriculum-story-release-gate.test.js",
  "tests/curriculum-story-ipad-parity.test.js",
  "tests/curriculum-story-ipad-sync.test.js",
  "tests/curriculum-voice-studio-export.test.js",
  "tests/concept-solution-floating.test.js",
  "tests/concept-progressive-stage.test.js",
  "tests/concept-mobile-density.test.js",
  "tests/curriculum-page-declutter.test.js",
