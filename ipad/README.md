# Matths iPhone·iPad 앱

SwiftUI로 만든 iPhone·iPad 유니버설 Matths 클라이언트입니다. 현재 프로젝트는 iOS/iPadOS
17 이상, Swift 5, 번들 ID `kr.matths.app`, 마케팅 버전 `0.1`/빌드 `1`을 기준으로 합니다.
...
3. iOS/iPadOS 17 이상 iPhone·iPad 또는 해당 시뮬레이터를 선택합니다.
4. Debug 구성으로 실행합니다.
...
- 실제 iPhone·iPad 설치에는 Apple Developer 서명 팀과 기기 개발자 모드가 필요합니다.
