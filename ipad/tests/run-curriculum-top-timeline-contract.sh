...
assert.match(compact, /ForEach\(Array\(scenes\.enumerated\(\)\)/,
  "선택한 story의 5장면만 렌더해야 합니다.");

console.log("Curriculum top timeline contract passed: one story, five compact nodes, universal AX states");
NODE
